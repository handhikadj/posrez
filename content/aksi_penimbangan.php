...
if ($module=='timbang' AND $act=='hapus'){
  mysqli_query($db, "DELETE FROM penimbangan WHERE id_penimbangan='$_GET[id]'");
...
elseif ($module=='timbang' AND $act=='input') {	
		...
		# code...
		mysqli_query($db, "INSERT INTO penimbangan (id_penimbangan,
												id_anak,
												tanggal_timbang,
												usia,
												berat_badan,
...
mysqli_query($db, "UPDATE penimbangan SET
